...
require (
	golang.conradwood.net/apis/common v1.1.2725
	golang.conradwood.net/go-easyops v0.1.23582
	golang.yacloud.eu/apis/session v1.1.2725
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2725 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2725 // indirect
