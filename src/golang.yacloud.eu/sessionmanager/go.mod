...
require (
	golang.conradwood.net/apis/common v1.1.4066
	golang.conradwood.net/go-easyops v0.1.37697
	golang.yacloud.eu/apis/session v1.1.4066
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.4066 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.4066 // indirect
