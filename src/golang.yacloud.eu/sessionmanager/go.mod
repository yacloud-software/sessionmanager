...
require (
	golang.conradwood.net/apis/common v1.1.2710
	golang.conradwood.net/go-easyops v0.1.23053
	golang.yacloud.eu/apis/session v1.1.2710
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2710 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2710 // indirect
