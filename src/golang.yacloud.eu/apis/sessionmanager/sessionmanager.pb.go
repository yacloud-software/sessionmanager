...
type SessionManagerClient interface {
	...
	// whoami, if no user, then send http 401 (triggering the client to authenticate)
	WhoAmIWithTriggerAuth(ctx context.Context, in *common.Void, opts ...grpc.CallOption) (*WhoAmIResponse, error)
}
...
func (c *sessionManagerClient) WhoAmIWithTriggerAuth(ctx context.Context, in *common.Void, opts ...grpc.CallOption) (*WhoAmIResponse, error) {
	out := new(WhoAmIResponse)
	err := grpc.Invoke(ctx, "/sessionmanager.SessionManager/WhoAmIWithTriggerAuth", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SessionManagerServer interface {
	...
	// whoami, if no user, then send http 401 (triggering the client to authenticate)
	WhoAmIWithTriggerAuth(context.Context, *common.Void) (*WhoAmIResponse, error)
}
...
func _SessionManager_WhoAmIWithTriggerAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(common.Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionManagerServer).WhoAmIWithTriggerAuth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sessionmanager.SessionManager/WhoAmIWithTriggerAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionManagerServer).WhoAmIWithTriggerAuth(ctx, req.(*common.Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SessionManager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WhoAmIWithTriggerAuth",
			Handler:    _SessionManager_WhoAmIWithTriggerAuth_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
